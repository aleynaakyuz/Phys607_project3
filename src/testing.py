#  This script is for testing with Gelman Rubin statistic.
import numpy as np

def Gelman_Rubin(var_ch):
  """
  Function that tests convergence of MCMC and returns
  a R-value. R-values close to 1 indicates good convergence.

  Parameters:
  -----------
  var_chain : numpy array, chains for one parameter
